...
ROWS = [
    ...
    ("kv", "Name", "Gaurav Chaudhary"),
    ("kv", "Role", "Software Developer @ ITSoftlab"),
    ("kv", "Username", "kaabilgaurav"),
    ...
    ("kv", "Backend", "Java • Spring Boot • Hibernate"),
    ("kv", "Database", "MySQL • MongoDB • Redis"),
    ...
    ("bul", "ERP Management System"),
    ("bul", "Chat Application"),
    ("bul", "Expense Tracker"),
]
...
parts.append(
    ...
    f'text-anchor="middle">kaabilgaurav@github: ~$ neofetch</text>'
)
